Going a layer above in the stack, we now look at the cluster management layer where resources are shared between multiple machine learning applications. Here, we observe that 
% \vspace{-0.05in}
